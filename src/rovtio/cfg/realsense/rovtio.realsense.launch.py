...
def generate_launch_description():
    return LaunchDescription([
        Node(
            ...
            parameters=[
                {'filter_config': '/home/aayush/code/own-code/src/rovtio/cfg/realsense/rovtio.realsense.info'},
                {'imu_topic': '/epson_imu/data'},
                {'camera_topic0': '/camera/camera/color/image_raw'},
                {'camera0_config': '/home/aayush/code/own-code/src/rovtio/cfg/realsense/realsense-color-rovio.yaml'},
                {'cam0_offset': 0.0},
