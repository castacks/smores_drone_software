...
def generate_launch_description():
    return LaunchDescription([
        Node(
            ...
            parameters=[
                {'filter_config': '/external/smores_drone_software/src/rovtio/cfg/extrinsics-calib/rovtio.phxpro.info'},
                {'imu_topic': '/epson_imu/data'},
                {'camera_topic0': '/thermal_left/image'},
                {'camera0_config': '/external/smores_drone_software/src/rovtio/cfg/extrinsics-calib/left-thermal-rovio2.yaml'},
                {'camera_topic1': '/thermal_right/image'},
                {'camera1_config': '/external/smores_drone_software/src/rovtio/cfg/extrinsics-calib/right-thermal-rovio2.yaml'},
                {'cam0_offset': 0.0},
                {'cam1_offset': 0.0},
