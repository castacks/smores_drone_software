...
public:
    FoundationStereoDepthNode()
        ...
        left_subscriber.subscribe(this, "/thermal_left/syncd_rectified", qos.get_rmw_qos_profile());
        right_subscriber.subscribe(this, "/thermal_right/syncd_rectified", qos.get_rmw_qos_profile());
